...
AWS scan bundle JSON | Level 4 for a local AWS CLI JSON subset | Basic graph validation plus security-group public ingress and reference inference | Not yet | No | No | `aws-scan-bundle-basic`, `awsscan-unknown-json`, `malformed-awsscan`
